...
(function (F, g, P) {
    'use strict';
    g.module("ngAnimate", ["ng"]).factory("$$animateReflow", ["$$rAF", "$document", function (g, F) {
        return function (e) {
            return g(function () {
                e()
            })
        }
    }]).config(["$provide", "$animateProvider", function (V, G) {
        function e(e) {
        ...
        V.decorator("$animate", ["$delegate", "$injector", "$sniffer", "$rootElement",
            "$$asyncCallback", "$rootScope", "$document", function (x, F, aa, K, E, H, P) {
                ...
                function L(a, b, c) {
                    function d(a, b) {
                        ...
                        if (c || d)return "leave" == b && (d = c, c = null), y.push({
                            event: b,
                            fn: c
                        }), l.push({event: b, fn: d}), !0
                    }
                ...
                function A(a, b, c, d, f, e, r) {
                    ...
                    if (l) {
                        ...
                        if (l.isClassBased && (n.disabled || C && !C.isClassBased) ||
                            ...
                            if (0 < y) {
                                n = [];
                                if (l.isClassBased)"setClass" == C.event ? (n.push(C), B(c, b)) : f[b] && (x = f[b], x.event == a ? d = !0 : (n.push(x), B(c, b))); else if ("leave" == a && f["ng-leave"])d = !0; else {
                                    for (var x in f)n.push(f[x]), B(c, x);
                                    f = {};
                                    y = 0
                                }
                            ...
                            if (d)q(), z(), s(); else {
                                if ("leave" == a)c.one("$destroy", function (a) {
                                    a = g.element(this);
                                    var b = a.data(h);
                                    b && (b = b.active["ng-leave"]) && (b.cancel(), B(a,
                                        "ng-leave"))
                                });
                                c.addClass(J);
                                var A = O++;
                                y++;
                                f[b] = l;
                                c.data(h, {last: l, active: f, index: A, totalActive: y});
                                q();
                                l.before(function (d) {
                                    var e = c.data(h);
                ...
                function B(a, b) {
                    ...
                    (r.running = !1, r.structural = !1); else if (b) {
                ...
                return {
                    enter: function (a, b, c, d) {
                        ...
                        a = u(a);
                        A("setClass", [b, c], a, null, null, function () {
                            x.setClass(a, b, c)
                        }, d)
        ...
        G.register("", ["$window", "$sniffer", "$timeout",
            "$$animateReflow", function (h, r, u, K) {
                ...
                function T(a, k, b, c) {
                    ...
                    k.data(n, {running: h.running || 0, itemIndex: p, stagger: g, timings: l, closeAnimationFn: m});
                ...
                function U(a, b, c, f) {
                    ...
                    if (-1 != l.className.indexOf(c) && a) {
                        ...
                        0 < u.length &&
                        (m = l.getAttribute("style") || "", l.setAttribute("style", m + " " + s));
                        b.on(y, h);
                        b.addClass(r);
                ...
                function a(a, b, c, e) {
                    if (T(a, b, c, e))return function (a) {
                        a && d(b, c)
                    }
                }

                function b(a, b, c, e) {
                    if (b.data(n))return U(a, b, c, e);
                    d(b, c);
                    e()
                }
                ...
                F.onanimationend ===
                P && F.onwebkitanimationend !== P ? (D = "-webkit-", q = "WebkitAnimation", z = "webkitAnimationEnd animationend") : (q = "animation", z = "animationend");
                var s = "Duration", t = "Property", v = "Delay", l = "IterationCount", w = "$$ngAnimateKey", n = "$$ngAnimateCSS3Data", y = "ng-animate-block-transitions", C = 3, V = 1.5, ca = 1E3, M = {}, da = 0, W = [], R, ea = null, fa = 0, Y = [];
                return {
                    enter: function (a, b) {
