...
(function (e) {
    ...
    function r(e) {
        function r(e) {
            if ("string" == typeof e && (e = document.querySelector(e)), e && "object" == typeof e && e.nodeType) {
                ...
                for (var l = i.isBorderBox = !!f && !!r[f] && "border-box" === r[f], c = 0, d = o.length; d > c; c++) {
                    var v = o[c], m = r[v];
                    m = u(e, m);
                    var g = parseFloat(m);
                    i[v] = isNaN(g) ? 0 : g
                }
                var y = i.paddingLeft + i.paddingRight, b = i.paddingTop + i.paddingBottom, w = i.marginLeft + i.marginRight, E = i.marginTop + i.marginBottom, S = i.borderLeftWidth + i.borderRightWidth, x = i.borderTopWidth + i.borderBottomWidth, T = l && a, N = t(r.width);
                N !== !1 && (i.width = N + (T ? 0 : y + S));
                var C = t(r.height);
                return C !== !1 && (i.height = C + (T ? 0 : b + x)), i.innerWidth = i.width - (y + S), i.innerHeight = i.height - (b + x), i.outerWidth = i.width + w, i.outerHeight = i.height + E, i
            }
        }
    ...
    function o(n, o, c, p, d, v) {
        ...
        var y = 0, b = {};
        return m.namespace = "outlayer", m.Item = v, m.prototype.options = {
            ...
            return Object.create ? r.prototype = Object.create(m.prototype) : t(r.prototype, m.prototype), r.prototype.constructor = r, g(r, "options"), t(r.prototype.options, n), r.namespace = e, r.data = m.data, r.Item = function () {
    ...
    function t(e, t) {
        ...
        return r.prototype._resetLayout = function () {
            ...
            e.getSize();
            var t = e.size.outerWidth % this.columnWidth, r = t && 1 > t ? "round" : "ceil", s = Math[r](e.size.outerWidth / this.columnWidth);
