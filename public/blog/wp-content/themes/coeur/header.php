...
<head>
  ...
  <body <?php body_class(); ?>>
    <div class="wrap">
      ...
      <div class="blog-header" style="background:url('<?php header_image(); ?>');background-size: cover;background-repeat: no-repeat;background-position: center;background-color:#FFF;">
